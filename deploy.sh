...
GITHUB_ACCESS_TOKEN="a65ab4ddac52e4ec077acfe6aa29e84b0a28f002"

# The slug of your WordPress.org plugin
PLUGIN_SLUG="ninja-page-categories-and-tags"

# GITHUB user who owns the repo
GITHUB_REPO_OWNER="wpninjas"

# GITHUB Repository name
GITHUB_REPO_NAME="ninja-pages"
...
rm -f README.md
rm -Rf apigen
rm -Rf assets/config.codekit
rm -Rf assets/scss/
rm -Rf assets/js/builder/
rm -Rf assets/js/front-end/
rm -Rf node_modules
